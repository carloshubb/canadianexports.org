...
class I2BSettingService
{
    ...
    public function fields($i2BSetting, $language, $request)
    {
        return [
            'i2b_setting_id' => $i2BSetting->id,
    ...
    public function store($i2BSetting, $language, $request)
    {
        $fields = $this->fields($i2BSetting, $language, $request);
        I2BSettingDetail::create($fields);
        return true;
    }

    public function update($i2BSetting, $language, $request)
    {
        $fields = $this->fields($i2BSetting, $language, $request);
        I2BSettingDetail::where('i2b_setting_id', $i2BSetting->id)->whereLanguageId($language->id)->update($fields);
        return true;
    }
}
