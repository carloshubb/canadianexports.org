...
class FaqExporterSettingService
{
    ...
    public function fields($faqExporterSetting, $language, $request)
    {
        return [
            'faq_exporter_setting_id' => $faqExporterSetting->id,
    ...
    public function store($faqExporterSetting, $language, $request)
    {
        $fields = $this->fields($faqExporterSetting, $language, $request);
        FaqExporterSettingDetail::create($fields);
        return true;
    }

    public function update($faqExporterSetting, $language, $request)
    {
        $fields = $this->fields($faqExporterSetting, $language, $request);
        FaqExporterSettingDetail::whereFaqExporterSettingId($faqExporterSetting->id)->whereLanguageId($language->id)->update($fields);
        return true;
    }
}
