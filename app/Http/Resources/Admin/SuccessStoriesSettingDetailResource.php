...
class SuccessStoriesSettingDetailResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'successStories_id' => $this->successStories_id,
            ...
            'success_stories_setting' => new SuccessStoriesSettingResource($this->whenLoaded('successStoriesSetting')),
        ];
    }
}
