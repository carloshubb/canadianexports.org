...
class FaqImporterSettingDetailResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'faq_importer_id' => $this->faq_importer_id,
            ...
            'faq_importer_setting' => new FaqImporterSettingResource($this->whenLoaded('faqImporterSetting')),
        ];
    }
}
