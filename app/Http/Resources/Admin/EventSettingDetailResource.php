...
class EventSettingDetailResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'event_setting_id' => $this->event_setting_id,
            ...
            'event_setting' => new EventSettingResource($this->whenLoaded('eventSetting')),
        ];
    }
}
