            ...
            <header class="pt-4">
                <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        ...
                        <router-link :to="{ name: 'admin.users.index' }" class="button-exp-fill">
                            Back
                        </router-link>
                    </div>
                </div>
                    ...
                    <div class="relative z-0 w-full group">
                        ...
                        <div class="relative">
                            <input :type="display_confirm_password" name="password_confirmation"
                                ...
                                class="can-exp-input w-full block border border-gray-300 rounded" placeholder=" "
                                :value="form.password_confirmation" @input="
                                    updateForm(
                        ...
                        <p class="mt-2 text-sm text-red-400" v-if="validationErros.has('password_confirmation')" v-text="validationErros.get('password_confirmation')
                            "></p>
                    </div>
                    <div class="relative z-0 w-full group">
                        <label for="package_id"> Package </label>
                        <select id="package_id" class="can-exp-input w-full block border border-gray-300 rounded"
                            @input="
                                updateForm('package_id', $event.target.value)
                                " :value="form && form.package_id ? form.package_id : ''
                                ">
                            <option value="">Select package...</option>
                            <option :value="p.id" v-for="p in packages" :key="p.id" :selected="form && form.package_id
                                    ? form.package_id
                                    : '' == p.id
                                ">
                        ...
                        <p class="mt-2 text-sm text-red-400" v-if="validationErros.has('package_id')"
                            v-text="validationErros.get('package_id')"></p>
                    </div>
                    <div class="relative z-0 w-full group">
