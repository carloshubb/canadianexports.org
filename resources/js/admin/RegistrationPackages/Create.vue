      ...
      <header class="pt-4">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between">
            ...
            <router-link :to="{ name: 'admin.registration_packages.index' }" class="button-exp-fill">
              Back
            </router-link>
          </div>
        </div>
      ...
      <form class="px-4 md:px-6 lg:px-8" @submit.prevent="addUpdateForm()">
        ...
        ">
          <div class="grid md:grid-cols-2 gap-4 md:gap-6 mt-6" v-if="form.type == 'profile'">
            ...
            <div class="relative z-0 w-full group">
              <label for="semi_annually_price">Semi annually price per month</label>
              <input type="text" name="semi_annually_price" id="semi_annually_price"
                class="can-exp-input w-full block border border-gray-300 rounded" placeholder=" "
                :value="form.semi_annually_price" @input="updateForm('semi_annually_price', $event.target.value)" />
              <p class="mt-2 text-sm text-red-400" v-if="validationErros.has('semi_annually_price')"
                v-text="validationErros.get('semi_annually_price')"></p>
            </div>
            <div class="relative z-0 w-full group">
              <label for="annually_price">Annually price per month</label>
              <input type="text" name="annually_price" id="annually_price"
                class="can-exp-input w-full block border border-gray-300 rounded" placeholder=" "
                :value="form.annually_price" @input="updateForm('annually_price', $event.target.value)" />
              <p class="mt-2 text-sm text-red-400" v-if="validationErros.has('annually_price')"
                v-text="validationErros.get('annually_price')"></p>
            </div>
          </div>
