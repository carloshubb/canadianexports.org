      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="can-exp-h3 mb-0 text-primary">Price packages</h1>
          ...
          <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <router-link
              :to="{ name: 'admin.coffee_on_wall_packages.create' }"
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr
                    ...
                    v-for="registration_package in coffee_wall_packages"
                  ...
                  >
                    ...
                    >
                      <div class="font-medium text-gray-900 flex items-center">
                        <span>{{
                          registration_package.coffee_wall_package_detail &&
                          registration_package.coffee_wall_package_detail[0]
                            ? registration_package
                                .coffee_wall_package_detail[0].name
                            : ""
                        }}</span>
                        <span
                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      @click="
                        fetchRegistrationPackages(pagination.prev_page_url)
                      "
                    >
                    ...
                    <a
                      ...
                      @click="
                        fetchRegistrationPackages(pagination.next_page_url)
                      "
                    >
...
export default {
  ...
  computed: {
    ...mapState({
      limit: (state) => state.coffee_wall_packages.limit,
      form: (state) => state.coffee_wall_packages.form,
      coffee_wall_packages: (state) =>
        state.coffee_wall_packages.coffee_wall_packages,
      pagination: (state) => state.coffee_wall_packages.pagination,
      validationErros: (state) => state.coffee_wall_packages.validationErros,
      searchParam: (state) => state.coffee_wall_packages.searchParam,
  ...
  methods: {
    fetchRegistrationPackages(page_url) {
      this.$store.dispatch("coffee_wall_packages/fetchRegistrationPackages", {
        url: page_url,
      });
    },
    updateLimit(value) {
      this.$store.commit("coffee_wall_packages/setLimit", value);
      this.$store.dispatch("coffee_wall_packages/fetchRegistrationPackages");
    },
    deleteRegistrationPackage(item) {
  this.$swal
    .fire({
        ...
        this.$swal
          ...
          .then((confirmResult) => {
            if (confirmResult.isConfirmed) {
              ...
              this.$store
                .dispatch("coffee_wall_packages/deleteRegistrationPackage", {
                  id: item.id,
    ...
    quickSearchFilter: _.debounce(function () {
      this.$store.commit(
        "coffee_wall_packages/setSearchParam",
        this.quickSearch
      );
      this.$store.dispatch("coffee_wall_packages/fetchRegistrationPackages");
    }, 500),
  ...
  created() {
    this.$store.commit("coffee_wall_packages/setLimit", 100);
    this.$store.commit("coffee_wall_packages/setSortBy", "package_name");
    this.$store.commit("coffee_wall_packages/setSortType", "asc");
