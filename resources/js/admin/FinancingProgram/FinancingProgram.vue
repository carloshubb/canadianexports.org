            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="can-exp-h3 mb-0 text-primary">Financing Program</h1>
                        <p class="mt-2 text-sm text-gray-700">
                            A list of all the Financing Program
                        </p>
                    </div>
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <router-link :to="{ name: 'admin.financingPrograms.create' }" class="button-exp-fill">
                            Add new Financing Program
                        </router-link>
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between mb-4">
                        ...
                        <div class="relative w-full md:w-auto">
                            ...
                            <form autocomplete="off" @submit.prevent>
                                <input type="text" id="table-search-financingPrograms"
                                    class="block pl-10 w-full md:w-80 bg-white can-exp-input" placeholder="Search"
                                    v-model="quickSearch" />
                            </form>
                        </div>
                    </div>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr class="hover:shadow-lg" v-for="financingProgram in financingPrograms"
                                        ...
                                        <td
                                            ...
                                            {{
                                                financingProgram.financing_program_details &&
                                                    financingProgram.financing_program_details[0]
                                            ? financingProgram.financing_program_details[0].name_title
                                            : ""
                                            }}
                                            <dl class="font-normal lg:hidden">
                                                ...
                                                <dd class="mt-1 truncate text-gray-500">
                                                    {{
                                                        financingProgram.financing_program_details &&
                                                            financingProgram.financing_program_details[0]
                                                    ? financingProgram.financing_program_details[0].business_name
                                                    : ""
                                                    }}
                                                </dd>
                                                ...
                                                <dd class="mt-1 truncate text-gray-500">
                                                    {{
                                                        financingProgram.financing_program_details &&
                                                            financingProgram.financing_program_details[0]
                                                    ? financingProgram.financing_program_details[0].email
                                                    : ""
                                                    }}
                                                </dd>
                                                <dt class="sr-only">Company Ownership</dt>
                                                <dd class="mt-1 truncate text-gray-500">
                                                    {{
                                                        financingProgram.financing_program_details &&
                                                            financingProgram.financing_program_details[0]
                                                    ? financingProgram.financing_program_details[0].company_ownership
                                                    : ""
                                                    }}
                                                </dd>
                                                <dt class="sr-only">Created</dt>
                                                <dd class="mt-1 truncate text-gray-500">
                                                    {{ formatDate(financingProgram.created_at) }}
                                                </dd>
                                            </dl>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center space-x-4">
                                                <router-link :to="{
                                                    ...
                                                    params: { id: financingProgram.id },
                                                }" data-tooltip="Edit financingProgram" class="text-gray-500 hover:text-gray-700">
                                                ...
                                                <a href="#" class="text-red-500 hover:text-red-700 cursor-pointer"
                                                    ...
                                                    @click.prevent="deleteFinancingProgram(financingProgram)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div>
                                    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                        ...
                                        <a href="#"
                                            ...
                                            @click="fetchFinancingPrograms(pagination.prev_page_url)">
                                        ...
                                        <a href="#"
                                            ...
                                            @click="fetchFinancingPrograms(pagination.next_page_url)">
...
export default {
    ...
    computed: {
        ...mapState({
            limit: (state) => state.financingPrograms.limit,
            form: (state) => state.financingPrograms.form,
            financingPrograms: (state) => state.financingPrograms.financingPrograms,
            pagination: (state) => state.financingPrograms.pagination,
    ...
    methods: {
        sendEmailToUsers() {
            this.$swal
                .fire({
                    title: "Are you sure you want to send this list via email?",
                    text: "This will send the list to all featured and premium users.",
                    icon: "question",
                        ...
                        this.$store
                            ...
                            .then((response) => {
                                if (response.data.status === "Success") {
                                    this.$swal.fire(
                                        "Sent!",
                                        "The list has been sent via email.",
                                        "success"
                                    );
                                } else {
                                    this.$swal.fire(
                                        "Error!",
                                        response.data.message || "Failed to send the email.",
                                        "error"
                                    );
                                }
                            })
        ...
        fetchFinancingPrograms(page_url) {
            this.$store.dispatch("financingPrograms/fetchFinancingPrograms", { url: page_url });
        },
        updateLimit(value) {
            this.$store.commit("financingPrograms/setLimit", value);
            this.$store.dispatch("financingPrograms/fetchFinancingPrograms");
        },
        deleteFinancingProgram(item) {
            this.$swal
                .fire({
    ...
    created() {
        this.$store.commit("financingPrograms/setLimit", 100);
        this.$store.commit("financingPrograms/setSortBy", "financingProgram_name_title");
        this.$store.commit("financingPrograms/setSortType", "asc");
