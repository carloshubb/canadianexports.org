              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr
                    ...
                    v-for="registration_package in packages"
                  ...
                  >
                    ...
                    >
                      <div class="font-medium text-gray-900 flex items-center">
                        <span>{{
                          registration_package.package_detail &&
                          registration_package.package_detail[0]
                            ? registration_package
                                .package_detail[0].name
                            : ""
                        }}</span>
                        <span
                      ...
                      <dl class="font-normal lg:hidden">
                        ...
                        <dd class="mt-1 truncate text-gray-500">
                          {{
                            registration_package?.package_detail?.[0]?.short_description || ""
                          }}
                        </dd>
                      </dl>
                    </td>
                    ...
                    >
                      <div class="flex items-center space-x-4">
                        ...
                        <a
                          ...
                          @click.prevent="
                            deletePackage(registration_package)
                          "
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      @click="
                        fetchPackages(pagination.prev_page_url)
                      "
                    >
                    ...
                    <a
                      ...
                      @click="
                        fetchPackages(pagination.next_page_url)
                      "
                    >
...
export default {
    ...
    deletePackage(item) {
      this.$swal
        .fire({
          ...
          preConfirm: (password) => {
            return this.$store
              .dispatch("packages/deletePackage", {
                id: item.id,
                password: password,
              })
              .then((res) => {
  ...
  created() {
    ...
    this.$store.commit("packages/setSortBy", "package_name");
