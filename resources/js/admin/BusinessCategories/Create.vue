    ...
    <AppLayout>
        <div class="relative shadow-md rounded-md bg-white py-4">
            ...
            <form class="px-4 md:px-6 lg:px-8" @submit.prevent="addUpdateForm()">
                ...
                <div
                    class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 w-full overflow-x-auto">
                    <ul class="flex mb-2 mt-4">
                        <li class="mr-2" v-for="language in languages" :key="language.id">
                            <a @click.prevent="changeLanguageTab(language)" href="#" :class="['inline-block rounded font-FuturaMdCnBT px-5 py-2 lg:text-lg md:text-base sm:text-base text-base hover:bg-blue-100 border border-primary text-center hover:border-blue-500 hover:text-blue-600',
