            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    ...
                    <p class="mt-2 text-sm text-gray-700">
                        A list of all the business categories created by Canadian Exporter admin
                    </p>
                    </div>
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <router-link :to="{ name: 'admin.business_categories.create' }"
            ...
            <div class="mt-8 flow-root">
                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr class="hover:shadow-lg" v-for="business_category in business_categories" :key="business_category.id">
                        ...
                        <td class="relative flex justify-end py-4 pl-3 pr-4 text-right text-sm font-medium">
                            <div class="flex items-center space-x-4">
                                <router-link :to="{ name: 'admin.business_categories.edit', params: { id: business_category.id } }"  data-tooltip="Edit business category" class="text-gray-500 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                    </svg>
                                </router-link>
                                <a href="#" class="text-red-500 hover:text-red-700 cursor-pointer" data-tooltip="Delete business category" @click.prevent="deleteBusinessCategory(business_category)">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
export default {
  ...
  this.$swal
      ...
      preConfirm: (password) => {
        return new Promise((resolve, reject) => {
          if (!password) {
            ...
            resolve(password); // Proceed to the second confirmation dialog
          }
        });
      },
    })
                ...
                .then((res) => {
                  if (res.data.status === "Success") {
                    ...
                    helper.swalErrorMessage(
                      res.data.message || "Business category deletion failed"
                    );
                  }
                })
                .catch((error) => {
                  helper.swalErrorMessage(error?.message || "Error deleting business category");
                });
            }
          });
      }
    ...
    created() {
        ...
        this.$store.commit("business_categories/setSortBy", "category_name");
