        ...
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">
              Import business directories by uploading excel file
            </p>
          </div>
          <div class="mt-4 flex md:ml-4 md:mt-0">
            <router-link
              :to="{ name: 'admin.business-directories.bulk.import' }"
              class="button-exp-fill"
            >
              Back to business directories
            </router-link>
          </div>
        </div>
...
export default {
  ...
  methods: {
    handleInputFile(e, field) {
      ...
      file.append("upload_dir", "business-directory/import");
    ...
    addUpdateForm() {
      this.loading = true;
      axios
        .post(`${process.env.MIX_ADMIN_API_URL}import-business-directory`, {
        ...
        .then((res) => {
          ...
          if (res.data.status == "Success") {
            ...
            this.$router.push({ name: "admin.business-directories.bulk.import" });
          } else {
