        ...
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">
              A list of all the languages enabled for website multilanguage feature
            </p>
          </div>
          ...
          <div class="flex flex-col md:flex-row items-center justify-between mb-4">
            ...
            <div class="relative w-full md:w-auto">
              ...
              <form autocomplete="off" @submit.prevent>
                <input type="text" id="table-search-languages" class="block pl-10 w-full md:w-80 bg-white can-exp-input"
            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr class="hover:shadow-lg" v-for="language in languages" :key="language.id">
                    <td
                      ...
                      <div class="flex items-center">
                        <div class="h-11 w-11 flex-shrink-0">
                          <img v-if="language.flag_icon" class="w-10 h-10 rounded-full"
                            :src="`/${language.flag_icon.path}`" alt="{{ language.name }}" />
                        </div>
                        <div class="ml-4">
                          <span>{{ language.name }}</span>
                          <span class="ml-2 bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded"
                    ...
                    <td class="relative flex justify-end py-4 pl-3 pr-4 text-right text-sm font-medium">
                      <div class="flex items-center space-x-4">
                        ...
                        }" data-tooltip="Edit language" class="text-gray-500 hover:text-gray-700">
                        ...
                        <a href="#" class="text-red-500 hover:text-red-700 cursor-pointer"
                          data-tooltip="Delete language" @click.prevent="deleteLanguage(language)">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
export default {
  ...
  methods: {
    setLoading(value) {
      this.$store.commit("languages/setLoading", value);
    },
    ...
    DownloadCSV() {
      this.$store
        ...
        .catch((error) => {
          helper.swalErrorMessage(error?.message || "Error downloading");
        });
    },
        ...
        .then(res => {
          if (res.data.status === "Success") {
            ...
            this.$swal.fire({
              icon: "error",
              title: "Error",
              text: res.data.message || "Import failed",
            });
          }
