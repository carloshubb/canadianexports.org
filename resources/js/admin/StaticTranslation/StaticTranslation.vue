    ...
    >
      <div
        v-for="field in [
          ...
          'business_profile_setting_text',
          'event_listing_text',
          'delete_profile_text',
          'logout_button_text',
          'view_company_profile_button_text',
          'process_button_text',
          ...
          'search_result_for_text',
          'profile_button_text',
          'search_button_text',
          'signup_modal_event_button',
          'signup_modal_exporter_button',
          'signup_modal_text','sponser_listing_text',
        ]"
        :key="field"
