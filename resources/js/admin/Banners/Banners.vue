      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all the sponsors</p>
          </div>
          <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <router-link
              :to="{ name: 'admin.banners.create' }"
                  ...
                  >
                    ...
                    >
                      <div class="flex items-center">
                        ...
                        <div class="ml-4">
                          <span>{{ banner?.business_name }}</span>
                        </div>
                      </div>
                    </td>
                    <td
                      class="w-full max-w-0 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-1"
                      v-html="banner?.small_business_description"
                    ></td>
                    <td
...
export default {
  ...
  created() {
    ...
    this.$store.commit("banners/setSortBy", "business_name");
