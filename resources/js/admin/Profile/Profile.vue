                    ...
                    <div class="grid my-5 grid-cols-1 sm:grid-cols-1 md:grid-cols-2  lg:grid-cols-2 gap-6 ">
                        <div class="relative z-0 w-full group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                :value="loggedInUser?.name" @input="updateForm('name', $event.target.value)" />
                        </div>
                        <div class="relative z-0 w-full group">
                    ...
                    <div class="grid my-5 md:grid-cols-3 md:gap-6 gap-4">
                        ...
                        <div class="relative z-0 w-full group">
                            ...
                            <input type="password" name="new_password" id="new_password"
                                class="can-exp-input w-full block border border-gray-300 rounded" placeholder=" "
                                @input="updateForm('new_password', $event.target.value)" :value="form.new_password" />
                        ...
                        <div class="relative z-0 w-full group">
                            ...
                            <input type="password" name="new_password_confirmation" id="new_password_confirmation"
                                class="can-exp-input w-full block border border-gray-300 rounded" placeholder=" "
                                @input="updateForm('new_password_confirmation', $event.target.value)"
