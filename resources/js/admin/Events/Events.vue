      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="can-exp-h3 mb-0 text-primary">Events</h1>
                      ...
                      <div class="flex items-center">
                        ...
                        <div class="ml-4">
                          <div class="font-medium text-gray-900">
                            {{
                              event.event_detail && event.event_detail[0]
                                ? event.event_detail[0].title
                                : ""
                            }}
                          </div>
                        </div>
                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      @click="fetchEvents(pagination.prev_page_url)"
                    >
                    ...
                    <a
                      ...
                      @click="fetchEvents(pagination.next_page_url)"
                    >
...
export default {
                ...
                .then((res) => {
                  if (res.data.status === "Success") {
                    helper.swalSuccessMessage(
                      res.data.message || "Event deleted successfully"
                    );
                    this.$store.dispatch("events/fetchEvents");
                  } else {
                    helper.swalErrorMessage(
                      res.data.message || "Event deletion failed"
                    );
                  }
                })
                .catch((error) => {
                  helper.swalErrorMessage(error?.message || "Error deleting event");
                });
            }
          });
      }
  ...
  created() {
    ...
    this.$store.commit("events/setSortBy", "event_title");
