      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="can-exp-h3 mb-0 text-primary">FAQs</h1>
            <p class="mt-2 text-sm text-gray-700">A list of all the FAQs</p>
          </div>
            ...
            >
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr class="hover:shadow-lg" v-for="faq in faqs" :key="faq.id">
                    <td
                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      @click="fetchFaqs(pagination.prev_page_url)"
                    >
                    ...
                    <a
                      ...
                      @click="fetchFaqs(pagination.next_page_url)"
                    >
...
export default {
  ...
  methods: {
    ...
    fetchFaqs(page_url) {
      this.$store.dispatch("faqs/fetchFaqs", { url: page_url });
    },
    updateLimit(value) {
                ...
                .then((res) => {
                  if (res.data.status === "Success") {
                    helper.swalSuccessMessage(
                      res.data.message || "FAQ deleted successfully"
                    );
                    this.$store.dispatch("faqs/fetchFaqs");
                  } else {
