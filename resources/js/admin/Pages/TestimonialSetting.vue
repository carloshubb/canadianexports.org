                    ...
                    <span class="flex items-start px-6 py-2 text-sm font-medium">
                      ...
                      <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                        ...
                        <span class="text-sm font-medium text-gray-500"
                          >Testimonial for the current rates form setting e.g.
        ...
        <div class="p-4 bg-gray-50 border-t" v-show="collapseStates[0]">
          ...
          <div class="relative z-0 w-full group">
            ...
            <div class="relative z-0 w-full group">
              ...
              <input
                ...
                :value="
                  ...
                  form['company_name_label'][`company_name_label_${selectedLanguage}`]
                    ? form['company_name_label'][`company_name_label_${selectedLanguage}`]
                    : ''
                "
              />
              ...
              <p
                class="mt-2 text-sm text-red-400"
                v-if="
                  validationErros.has(`company_name_label.company_name_label_${selectedLanguage}`)
                "
                v-text="
                  validationErros.get(`company_name_label.company_name_label_${selectedLanguage}`)
                "
              ></p>
            </div>
            <div class="relative z-0 w-full group">
              <label
                ...
                >Company name placeholder</label
              >
              <input
                type="text"
                ...
                :value="
                  ...
                  form['company_name_placeholder'][`company_name_placeholder_${selectedLanguage}`]
                    ? form['company_name_placeholder'][
            ...
            <div class="relative z-0 w-full group">
              ...
              <input
                ...
                :value="
                  ...
                  form['company_name_error'][`company_name_error_${selectedLanguage}`]
                    ? form['company_name_error'][`company_name_error_${selectedLanguage}`]
                    : ''
                "
              />
              ...
              <p
                class="mt-2 text-sm text-red-400"
                v-if="
                  validationErros.has(`company_name_error.company_name_error_${selectedLanguage}`)
                "
                v-text="
                  validationErros.get(`company_name_error.company_name_error_${selectedLanguage}`)
                "
              ></p>
            </div>
            <div class="relative z-0 w-full group">
              <label
                class="block text-sm font-medium leading-6 text-gray-900"
                :for="`business_categories_label_${selectedLanguage}`"
                >Business categories label</label
              >
              <input
                type="text"
                :name="`business_categories_label_${selectedLanguage}`"
                ...
                :value="
                  ...
                  form['business_categories_label'][`business_categories_label_${selectedLanguage}`]
                    ? form['business_categories_label'][`business_categories_label_${selectedLanguage}`]
                    : ''
                "
              />
              ...
              <p
                class="mt-2 text-sm text-red-400"
                v-if="
                  validationErros.has(`business_categories_label.business_categories_label_${selectedLanguage}`)
                "
                v-text="
                  validationErros.get(`business_categories_label.business_categories_label_${selectedLanguage}`)
                "
              ></p>
            </div>
            <div class="relative z-0 w-full group">
              <label
                class="block text-sm font-medium leading-6 text-gray-900"
                :for="`business_categories_placeholder_${selectedLanguage}`"
                >Business categories placeholder</label
              >
              <input
                type="text"
                :name="`business_categories_placeholder_${selectedLanguage}`"
                ...
                :value="
                  ...
                  form['business_categories_placeholder'][`business_categories_placeholder_${selectedLanguage}`]
                    ? form['business_categories_placeholder'][
            ...
            <div class="relative z-0 w-full group">
              <label
                class="block text-sm font-medium leading-6 text-gray-900"
                :for="`business_categories_error_${selectedLanguage}`"
                >Business categories error</label
              >
              <input
                type="text"
                :name="`business_categories_error_${selectedLanguage}`"
                ...
                :value="
                  ...
                  form['business_categories_error'][`business_categories_error_${selectedLanguage}`]
                    ? form['business_categories_error'][`business_categories_error_${selectedLanguage}`]
                    : ''
                "
              />
              ...
              <p
                class="mt-2 text-sm text-red-400"
                v-if="
                  validationErros.has(`business_categories_error.business_categories_error_${selectedLanguage}`)
                "
                v-text="
                  validationErros.get(`business_categories_error.business_categories_error_${selectedLanguage}`)
                "
              ></p>
            </div>
    ...
    methods: {
      ...
      fetchPageSetting() {
        this.$store
          .dispatch("pages/fetchPage", {
            url: `${process.env.MIX_ADMIN_API_URL}testimonial-setting?withTestimonialSettingDetail=1&findByPageId=${this.form.id}`,
          })
          .then((res) => {
            let data =
              res.data.data && res.data.data.testimonial_setting_detail
                ? res.data.data.testimonial_setting_detail
                : [];
            ...
            obj = {};
            data.map((res) => {
              obj["company_name_label_" + res.language_id] = res.name_label;
            });
            this.$store.commit("pages/setHomePageSetting", {
            ...
            obj = {};
            data.map((res) => {
              obj["company_name_placeholder_" + res.language_id] = res.name_placeholder;
            });
            this.$store.commit("pages/setHomePageSetting", {
            ...
            obj = {};
            data.map((res) => {
              obj["company_name_error_" + res.language_id] = res.name_error;
            });
            this.$store.commit("pages/setHomePageSetting", {
            ...
            obj = {};
            data.map((res) => {
              obj["business_categories_label_" + res.language_id] = res.name_label;
            });
            this.$store.commit("pages/setHomePageSetting", {
            ...
            obj = {};
            data.map((res) => {
              obj["business_categories_placeholder_" + res.language_id] = res.name_placeholder;
            });
            this.$store.commit("pages/setHomePageSetting", {
            ...
            obj = {};
            data.map((res) => {
              obj["business_categories_error_" + res.language_id] = res.name_error;
            });
            this.$store.commit("pages/setHomePageSetting", {
      ...
      checkValidationError(validationErros, language) {
        return (
          ...
          validationErros.has(`company_name_label.company_name_error_${language.id}`) ||
          validationErros.has(
          ...
          validationErros.has(`business_categories_label.business_categories_error_${language.id}`) ||
          validationErros.has(
            `business_categories_placeholder.business_categories_placeholder_${language.id}`
          ) ||
