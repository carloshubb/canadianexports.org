      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="can-exp-h3 mb-0 text-primary">Website pages</h1>
            <p class="mt-2 text-sm text-gray-700">
              A list of all the website pages created by Canadian Export admin.
            </p>
          </div>
                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      @click="fetchPages(pagination.prev_page_url)"
                    >
