                    ...
                    <li class="relative overflow-hidden lg:flex-1">
                        ...
                        <div class="group w-full">
                            ...
                            <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                                ...
                                <span class="text-sm font-medium text-gray-500">Event page settings</span>
                            </span>
                            </span>
                        </div>
        ...
        fetchPageSetting() {
            this.$store
                .dispatch("pages/fetchPage", {
                    url: `${process.env.MIX_ADMIN_API_URL}event-setting?withEventSettingDetail=1&findByPageId=${this.form.id}`,
                })
                .then((res) => {
                    let data = res.data.data && res.data.data.event_setting_detail
                            ? res.data.data.event_setting_detail
                            : [];
