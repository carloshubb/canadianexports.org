        ...
        <div class="border rounded w-full" :class="collapseStates[0] ? 'bg-blue-50' : ''">
                    ...
                    <li class="relative overflow-hidden lg:flex-1">
                        ...
                        <div class="group w-full">
                            ...
                            <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                                ...
                                <span class="text-sm font-medium text-gray-500">Close accounts page settings</span>
                            </span>
                            </span>
                        </div>
          ...
          <div class="relative z-0 w-full group">
            ...
            ></p>
                    ...
                    <div class="relative z-0 w-full group">
                        <label class="block text-sm font-medium leading-6 text-gray-900" :for="`button_text_${selectedLanguage}`">Close account button text</label>
        ...
        fetchPageSetting() {
            this.$store
                .dispatch("pages/fetchPage", {
                    url: `${process.env.MIX_ADMIN_API_URL}close-account-setting?withCloseAccountSettingDetail=1&findByPageId=${this.form.id}`,
                })
                .then((res) => {
                    let data = res.data.data && res.data.data.close_account_setting_detail
