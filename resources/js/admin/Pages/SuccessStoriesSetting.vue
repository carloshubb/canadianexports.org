                    ...
                    <span class="flex items-start px-6 py-2 text-sm font-medium">
                      ...
                      <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                        ...
                        <span class="text-sm font-medium text-gray-500"
                          >Success stories form setting e.g.
      ...
      fetchPageSetting() {
        this.$store
          .dispatch("pages/fetchPage", {
            url: `${process.env.MIX_ADMIN_API_URL}success-stories-setting?withSuccessStoriesSettingDetail=1&findByPageId=${this.form.id}`,
          })
          .then((res) => {
            let data =
              res.data.data && res.data.data.success_stories_setting_detail
                ? res.data.data.success_stories_setting_detail
                : [];
