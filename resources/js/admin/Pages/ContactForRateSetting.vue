                  ...
                  <span class="flex items-start px-6 py-2 text-sm font-medium">
                    ...
                    <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                      ...
                      <span class="text-sm font-medium text-gray-500"
                        >Contact us for the current rates form setting e.g.
        ...
        >
          ...
          <div class="relative z-0 w-full group">
            <label
              ...
              >Business name placeholder</label
            >
            <input
              type="text"
          ...
          <div class="relative z-0 w-full group">
            ...
            <input
              ...
              :value="
                form['phone_label'] &&
                form['phone_label'][`phone_label_${selectedLanguage}`]
                  ? form['phone_label'][`phone_label_${selectedLanguage}`]
                  : ''
              "
            />
          ...
          <div class="relative z-0 w-full group">
            ...
            <input
              ...
              :value="
                form['phone_error'] &&
                form['phone_error'][`phone_error_${selectedLanguage}`]
                  ? form['phone_error'][`phone_error_${selectedLanguage}`]
                  : ''
              "
            />
  ...
  methods: {
    ...
    fetchPageSetting() {
      this.$store
        .dispatch("pages/fetchPage", {
          url: `${process.env.MIX_ADMIN_API_URL}contact-for-rate-setting?withContactForRateSettingDetail=1&findByPageId=${this.form.id}`,
        })
        .then((res) => {
          let data =
            res.data.data && res.data.data.contact_for_rate_setting_detail
              ? res.data.data.contact_for_rate_setting_detail
              : [];
          ...
          obj = {};
          data.map((res) => {
            obj["business_name_label_" + res.language_id] =
              res.business_name_label;
          });
          this.$store.commit("pages/setHomePageSetting", {
          ...
          obj = {};
          data.map((res) => {
            obj["business_name_error_" + res.language_id] =
              res.business_name_error;
          });
          this.$store.commit("pages/setHomePageSetting", {
          ...
          obj = {};
          data.map((res) => {
            obj["phone_placeholder_" + res.language_id] = res.phone_placeholder;
          });
          this.$store.commit("pages/setHomePageSetting", {
    ...
    checkValidationError(validationErros, language) {
      return (
        ...
        validationErros.has(
          `business_name_label.business_name_error_${language.id}`
        ) ||
        validationErros.has(
          `business_name_placeholder.business_name_placeholder_${language.id}`
        ) ||
        validationErros.has(
          `business_name_error.business_name_error_${language.id}`
        ) ||
        validationErros.has(`phone_label.phone_error_${language.id}`) ||
        validationErros.has(
          `phone_placeholder.phone_placeholder_${language.id}`
        ) ||
        validationErros.has(`phone_error.phone_error_${language.id}`) ||
        validationErros.has(
