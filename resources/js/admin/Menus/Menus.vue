      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="can-exp-h3 mb-0 text-primary">Website menu</h1>
            <p class="mt-2 text-sm text-gray-700">
              A list of all the menu used on website
            </p>
          </div>
          <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <router-link
              :to="{ name: 'admin.menus.create' }"
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                >
                  ...
                  >
                    ...
                    <td
                      class="relative flex py-4 pl-3 pr-4 text-right text-sm font-medium justify-end"
                    >
                      <div class="flex items-center space-x-4">
                        <router-link
                          ...
                          class="inline-flex rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                ...
                <div>
                  ...
                  >
                    ...
                    <a
                      ...
                      @click="fetchMenus(pagination.next_page_url)"
                    >
...
export default {
  ...
  methods: {
    ...
    deleteMenu(item) {
    // First SweetAlert to enter password
    this.$swal
        .fire({
            title: "Enter password",
            input: "password",
        ...
        .then((result) => {
            if (result.isConfirmed) {
                // Second SweetAlert to confirm deletion
                this.$swal
                    .fire({
                        ...
                        if (confirmResult.isConfirmed) {
                            ...
                            this.$store
                                ...
                                .then((res) => {
                                    ...
                                    if (res.data.status === "Success") {
                                        helper.swalErrorMessage(res.data.message || "Failed to delete the menu.");
                                        this.$store.dispatch("menus/fetchMenus"); // Refresh the menu list
                                    }
                                    else {
                                        helper.swalSuccessMessage(res.data.message || "Menu deleted successfully.");
                                    }
                                })
                                .catch((error) => {
                                    // Handle any errors during deletion
                                    helper.swalErrorMessage(error?.message || "Error occurred while deleting the menu.");
                                });
                        }
                    });
            }
