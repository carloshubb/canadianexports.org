        ...
        <div class="flex justify-between items-center bg-gray-50 px-4 py-2 rounded-md">
          ...
          <div class="flex justify-between space-x-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-5 h-5 cursor-pointer" @click.prevent="updateCurrentId(element.id)"
              v-if="currnetItemId != element.id || currnetItemId == null">
              <path stroke-linecap="round" stroke-linejoin="round"
                d="M19.5 5.25l-7.5 7.5-7.5-7.5m15 6l-7.5 7.5-7.5-7.5" />
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-5 h-5 cursor-pointer" v-else @click.prevent="updateCurrentId(null)">
              <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="relative z-0 w-full group mt-2">
              ...
              <div
                ...
                <input type="text" name="link" id="link"
                  class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 cursor-not-allowed"
                  placeholder="" :value="element.link" @input="updateMenuItem(element, $event.target.value, 'link')"
            ...
            <div class="relative z-0 w-full group mt-2">
              ...
              <div
                ...
                <input type="text" name="name" id="name"
                  ...
                  placeholder="" :value="element.name" @input="updateMenuItem(element, $event.target.value, 'name')">
              </div>
            </div>
          </div>
        </div>
