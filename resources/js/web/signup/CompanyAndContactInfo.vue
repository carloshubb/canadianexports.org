        ...
        <div class="border border-gray-200 rounded-lg p-6 bg-white shadow-sm">
          ...
          <div class="relative w-full mb-8">
            ...
            <input type="text" id="email" class="can-exp-input min-h-[60px] lg:min-h-full"
              ...
              :disabled="profile == '1' && user && JSON.parse(user || '{}')?.is_package_amount_paid == '0'"
              :class="profile == '1' && user && JSON.parse(user || '{}')?.is_package_amount_paid == '0' ? 'opacity-50 cursor-not-allowed' : ''" />
          ...
          <div class="relative w-full mb-8" v-if="profile != '1'">
            ...
            <div class="relative">
              ...
              <svg class="w-5 h-5 text-gray-500 absolute top-3" :class="lang && JSON.parse(lang) && JSON.parse(lang)['direction'] == 'ltr' ? 'right-3' : 'left-3'"
