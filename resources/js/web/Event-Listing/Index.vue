<template>
    <div class="rounded-lg bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 p-0.5 hover:-translate-y-2 transition-all duration-500 ease-in-out relative"
        :id="event && JSON.parse(event) ? `event-${JSON.parse(event)['id']}` : ''
            ">
        <div class="group flex flex-col h-full pb-6 pt-4 text-sm rounded-lg shadow bg-white relative z-0 aaa">
            <div v-if="page == 'advance_search'"
                ...
                <img class="h-6 cursor-pointer" src="/assets/icons/19-X-inside-circle-2.png" alt="Candian Exporters" />
            </div>
                    ...
                    <a aria-label="Candian Exporters" :href="url" class="">
                        ...
                        <template v-else>
                            <img class="h-60 rounded aspect-video object-contain w-full"
                                src="/assets/images/logocircle.png" alt="Candian Exporters" />
                        </template>
                    </a>
                </div>
                <div class="content mt-3">
                    <div class="px-6">
                        <a aria-label="Candian Exporters" :href="url" class="card-heading flex-auto">{{
            ...
            <div class="flex-end px-6">
                <div class="flex items-center gap-2 justify-between">
                    ...
                    <a aria-label="Candian Exporters" :href="JSON.parse(event)['event_website']" target="_blank"
