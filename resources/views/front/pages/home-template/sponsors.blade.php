...
<section class="home-container bg-[#F3F7FA] lg:py-[100px] md:pt-10 md:pb-10 pt-10 pb-10 desktop:px-80">
    ...
    <span class="text-gray-600">{{ __('Explore these extensive Business Categories, each featuring reputable and export-ready and bring their high-quality products and services to your market.') }}</span>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide h-full">
                    <div class="relative bg-white w-full border border-[#c9dbe9] shadow-md shadow-blue-500/20 flex flex-row h-[256px] overflow-hidden sponsor-swiper-slide">
                        ...
                        <a aria-label="{{ __('Canadian Exporters') }}" href="{{ $banner->url }}" target="_blank"
                            ...
                            <img src="{{ asset($imageSource) }}"
                                class="object-cover w-full h-full min-w-full min-h-full" alt="{{ __('sponsor banner') }}" />
                            @else
    ...
    <div class="mt-8 flex justify-center gap-4">
        ...
        @endphp
        <a aria-label="{{ __('Canadian Exporters') }}" href="{!! $url !!}" class="button-exp-fill flex justify-center items-center w-64 h-[56px] rounded-none">
        ...
        $url = langBasedURL($lang, $url);
        @endphp
        <a aria-label="{{ __('Canadian Exporters') }}" href="{{ $url }}" class="button-exp-no-fill bg-black text-white border-0 flex justify-center items-center w-64 h-[56px] rounded-none">
