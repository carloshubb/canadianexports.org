                ...
                <section class="">
                    ...
                    <div class="container">
                        ...
                        <div class="mt-8 gap-5">
                            @php
                                $faqs = getAllFaqs('importer', 0, $lang);
                            @endphp
                            @foreach ($faqs as $faq)
    ...
    @isset($faqImporterSettingDetail)
            ...
            <div class="lg:pt-14 lg:pb-14 md:pt-10 md:pb-10 pt-10 pb-10">
                <section class="">
                    ...
                    <div class="container">
                        ...
                        <h1 class="text-center">{{ $faqImporterSettingDetail->page_heading }}</h1>
                        <p class="text-red-500"><span class="text-red-500">*</span>
                            {{ $faqImporterSettingDetail->required_fields_text }}</p>
                    </div>
                    <!--Tabs-->
                    <div class="grid grid-cols-1 gap-12 container">
                        <div class="order-2 md:order-1">
                            <faq-importer faq_importer_setting="{{ $faqImporterSettingDetail }}"
                                submit_url="{{ route('user.faq-importer.send-message') }}" page_id="{{ $page->id }}">
                            </faq-importer>
                        </div>
