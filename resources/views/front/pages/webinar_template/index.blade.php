                ...
                <section>
                    ...
                    <div class="container mt-8">
                            ...
                            <div class="bg-white rounded-lg shadow-md p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h2 class="text-2xl font-bold text-primary">
                                        {{ $webinarSettingDetail['my_webinars_heading'] ?? __('My Webinars') }}
                                    </h2>
                                    <a href="{{ route('member.webinars', ['abbreviation' => $langAbbreviation]) }}" class="button-exp-fill">
                                        {{ $webinarSettingDetail['manage_btn_text'] ?? __('Manage My Webinars') }}
                                    </a>
                                </div>
                        ...
                        <webinars-index
                            ...
                            :webinar-setting-detail='@json($webinarSettingDetail ?? [])'></webinars-index>
