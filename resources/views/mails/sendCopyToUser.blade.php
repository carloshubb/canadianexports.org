...
<p>Thank you for contacting <strong>{{ $advertiserName }}</strong> on the Canadian Exports platform. Here is a copy of your message:</p>
<hr>
<p>{{ $messageContent }}</p>
<hr>
<p>Note: If you believe this email has reached you in error, please contact us as soon as possible</p>
...
<p style="text-align: justify;color: #000;margin-bottom: 0;">
    Please do not reply to this message; it is an automated email, and all replies to it are routed to an unmonitored mailbox
    If you have any questions or need assistance, do not hesitate to contact our customer support team at
    <a href="mailto:support@canadianexports.org">support@canadianexports.org</a> or call us toll-free at <a href="tel:+18773333014">1-877-333-3014</a>,
    Monday to Friday, between 9:30 AM and 5:00 PM EST
</p>
@endcomponent
