...
{{-- <p>The following is a reply to your "{{ $company_name }}" on <a href="{{route('front.index')}}">www.canadianexports.org</a>:</p> --}}
<p style="text-align: justify;">You have received a new message from your exporter profile on Canadian Exports</a>:</p>
