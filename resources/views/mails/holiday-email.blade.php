...
<p>{{$data['holiday_email']['email_content']}}</p>
<p>Please note that our office will be closed from {{ date('m/d/Y', strtotime($data['holiday_email']['holidays_from'])) }} to {{ date('m/d/Y', strtotime($data['holiday_email']['holidays_to'])) }} as our team takes a well-deserved break to recharge and prepare for the exciting year ahead.</p>
...
<p style="text-align: justify;color: #000;margin-bottom: 0;">
    ...
    We send this email only once a year, but you still can <a href="{{ $unsubscribeLink }}" >Unsubscribe</a> if you wish</p>
