        ...
        <div class="flex items-end justify-center h-full w-full relative max-w-screen-2xl mx-auto">
            ...
            <div class="absolute error_outer pt-20 xl:pt-0 w-full md:w-2/3 lg:w-1/2 h-[44rem]">
                ...
                <div class="text-center my-20 w-full mx-auto px-6 lg:my-12">
                    <h1 class="can-exp-h1 text-white">We will be back online momentarily.</h1>
                    <p class="text-white text-center">We apologize for any inconvenience caused as we are currently
                        undergoing some technical maintenance. For prompt help, please reach us at <a
                            class="hover:text-white"
                            href="mailto:info@canadianexports.org">info@canadianexports.org</a>, or contact us on
                        1-877-333-3014. We will be back online momentarily. Thank you for your patience!
                        <br class="hidden md:block">
                        &mdash; Canadian Exporter team
                    </p>
