...
//     // Check if the clicked element is not inside the menu container
//     if (menuContainer && !menuContainer.contains(event.target)) {
//         document.querySelector('.isToggle').click();
//     }
// });
...
//         setTimeout(function () {
//             isOpen.style.opacity = "1";
//         },); // Wait for display to be set before applying opacity (adjust as needed)
//     }
// }
