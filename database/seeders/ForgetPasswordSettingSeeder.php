...
class ForgetPasswordSettingSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $result = StaticTranslation::where('type', 'forget_password_setting')->first();
        if (!$result) {
            $result = StaticTranslation::create([
                'display_text' => 'Forget password setting',
                'type' => 'forget_password_setting',
            ]);
        }
