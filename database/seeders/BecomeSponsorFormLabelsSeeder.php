    ...
    public function run()
    {
        $translations = [
            'en' => [
                ...
                // SponsorshipsList labels
                'manage_sponsorship_heading' => 'Manage Sponsorship',
                'manage_sponsorship_subtitle' => 'Review your active sponsorship details and payment history.',
                'manage_sponsorship_thanks' => 'Thank you for your continued support of the Canadian export community.',
                'add_another_sponsorship_btn' => 'Add Another Sponsorship',
                'loading_sponsorships' => 'Loading your sponsorships...',
                'no_sponsorships_heading' => 'No sponsorships yet',
                'no_sponsorships_message' => 'Get started by creating your first sponsorship.',
                'create_first_sponsorship_btn' => 'Create Your First Sponsorship',
                'status_active' => 'Active',
                'status_pending' => 'Pending',
                'status_inactive' => 'Inactive',
                'change_frequency_btn' => 'Change Frequency or Amount',
                'collapse_btn' => 'Collapse',
                'payment_status_paid' => 'Paid',
                'payment_status_pending' => 'Payment Pending',
                'payment_status_not_required' => 'Contact Request',
                ...
                'edit_btn' => 'Edit',
                'reactivation_panel_message' => 'Complete the reactivation form below to renew this sponsorship.',
                'next_billing_date_label' => 'Next Billing Date',
                'upgrade_btn' => 'Upgrade',
                'reactivate_heading' => 'Reactivate Sponsorship',
                'loading_overlay_text' => 'Loading...',
                'payment_method_ending_in' => 'ending in',
            ],
            'es' => [
                ...
                // SponsorshipsList labels
                'manage_sponsorship_heading' => 'Administrar patrocinio',
                'manage_sponsorship_subtitle' => 'Revise los detalles de su patrocinio activo y el historial de pagos.',
                'manage_sponsorship_thanks' => 'Gracias por su continuo apoyo a la comunidad de exportadores canadienses.',
                'add_another_sponsorship_btn' => 'Añadir otro patrocinio',
                'loading_sponsorships' => 'Cargando sus patrocinios...',
                'no_sponsorships_heading' => 'Aún no hay patrocinios',
                'no_sponsorships_message' => 'Comience creando su primer patrocinio.',
                'create_first_sponsorship_btn' => 'Crear su primer patrocinio',
                'status_active' => 'Activo',
                'status_pending' => 'Pendiente',
                'status_inactive' => 'Inactivo',
                'change_frequency_btn' => 'Cambiar frecuencia o monto',
                'collapse_btn' => 'Contraer',
                'payment_status_paid' => 'Pagado',
                'payment_status_pending' => 'Pago pendiente',
                'payment_status_not_required' => 'Solicitud de contacto',
                ...
                'edit_btn' => 'Editar',
                'reactivation_panel_message' => 'Complete el formulario de reactivación a continuación para renovar este patrocinio.',
                'next_billing_date_label' => 'Próxima fecha de facturación',
                'upgrade_btn' => 'Actualizar',
                'reactivate_heading' => 'Reactivar patrocinio',
                'loading_overlay_text' => 'Cargando...',
                'payment_method_ending_in' => 'terminando en',
            ],
        ];
